<div class="mb-4">
    <div class="container"><p>Total video: {{ $count }}</p></div>
    <div class="sticky-top container">
        <div class="input-group mb-3 bg-light">
            <input wire:model.debounce.800ms="search_key" wire:input="searchVideo" type="text" class="form-control outline-none"
                    ...
                    <div class="bg-secondary relative" style="height: 250px">
                        ...
                        <div class="absolute">
                            <video width="100%" controls>
                                <source data-src="{{ url("api/download/{$item->uid}") }}" type="video/mp4">
                                <source data-src="{{ url("api/download/{$item->uid}") }}" type="video/webm">
